...
public class RestClient {
    ...
    public static void main(String[] args) {
        ...
        registerUser("http://localhost:" + port + "/services/users/register.json",
            MediaType.APPLICATION_JSON_TYPE);

        registerUser("http://localhost:" + port + "/services/users/register.xml",
        ...
        registerUser("http://localhost:" + port + "/services/u/register.json",
            MediaType.APPLICATION_JSON_TYPE);

        registerUser("http://localhost:" + port + "/services/u/register.xml",
            MediaType.TEXT_XML_TYPE);
        ...
        registerUser("http://localhost:" + port + "/services/customers/register.json",
            MediaType.APPLICATION_JSON_TYPE);

        registerUser("http://localhost:" + port + "/services/customers/register.xml",
            MediaType.TEXT_XML_TYPE);
